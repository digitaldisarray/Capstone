...
public class LoopingByteInputStream extends ByteArrayInputStream {
	...
	/**
	 * Creates a new LoopingByteInputStream with the specified byte array. The array
	 * is not copied.
	 */
	...
	/**
	 * Reads <code>length</code> bytes from the array. If the end of the array is
	 * reached, the reading starts over from the beginning of the array. Returns -1
	 * if the array has been closed.
	 */
